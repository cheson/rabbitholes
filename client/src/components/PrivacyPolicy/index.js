...
export default function PrivacyPolicy() {
  return (
    <div className={styles.privacyPolicy}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to rabbitholes.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to rabbitholes, accessible from{" "}
            <a
              href="www.rabbitholes.ooo"
      ...
      <ul>
        <li>By email: flowwebsitedev@gmail.com</li>
      </ul>
    </div>
  );
}
